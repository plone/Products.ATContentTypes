...
def registerMigrations():
    ...
    atct.registerUpgradePath('1.1.3-final',
                             '1.1.4-final',
                             null)
    atct.registerUpgradePath('1.1.4-final',
                             '1.1.5-final',
                             null)
    atct.registerUpgradePath('1.1.5-final',
                             '1.1.6-final',
                             null)
    atct.registerUpgradePath('1.1.6-final',
                             '1.1.7-final',
                             null)
    atct.registerUpgradePath('1.1.7-final',
                             '1.1.8-final',
                             null)
    atct.registerUpgradePath('1.1.8-final',
                             '1.1.9-devel (svn/unreleased)',
                             null)
